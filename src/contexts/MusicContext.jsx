...
export const MusicProvider = ({ children }) => {
      ...
      return <MusicContext.Provider value={{ allSongs, handlePlaySong, currentTrack, currentTrackIndex, currentTime,
       setCurrentTime, formatTime, duration, setDuration,
       nextTrack, prevTrack, isPlaying, play, pause, volume, setVolume }}>{children}</MusicContext.Provider>;
